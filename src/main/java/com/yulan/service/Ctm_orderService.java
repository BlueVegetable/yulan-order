...
public interface Ctm_orderService {
   //获取订单列表
   Map getOrders(Integer st,Integer number,String cid,String state_id,String find,String beginTime,String finishTime,String orderType,String curtainStatusId,String company) throws UnsupportedEncodingException;

   //获取订单详情
   Map getOrderContent(String order_no,String cid,String company) throws UnsupportedEncodingException;
